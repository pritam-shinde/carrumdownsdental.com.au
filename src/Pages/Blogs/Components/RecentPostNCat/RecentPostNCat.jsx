...
import { Box, Grid, Paper, Typography, List, ListItem, ListItemIcon, ListItemText, CircularProgress, Container } from '@mui/material';
        ...
        <>
            <Box className="recentPostNCat" style={{ height: "100%" }}>
                <Box mb={5} component={Paper} className="shadow" style={{ backgroundColor: "#11527826", borderRadius: "1.2rem" }} >
                    ...
                    <Box p={3}>
                        {
                            blogs.length > 0 ? blogs.slice(0, 5).map(item => <Box mb={3} key={item.id}>
                            ...
                            </Box>) : <Container style={{ height: "40vh" }} className="d-flex justify-content-center align-items-center">
                                <Box sx={{ display: 'flex' }}>
                                    <CircularProgress />
                                </Box>
                            </Container>
                    ...
                    <Box p={3}>
                        {
                            ...
                            </List> : <Container style={{ height: "40vh" }} className="d-flex justify-content-center align-items-center">
                                <Box sx={{ display: "flex" }}>
                                    <CircularProgress />
                                </Box>
                            </Container>
