const Data = [{
    id: "privacy-policy1",
    title: [{id: "privacy-policy1.head1", varaint: "h4", text: "Our Dental Practice Privacy Policy & Terms and conditions of The Site Respecting Your Privacy and the law"}],
    para: ["At Carrum Downs Dental Group, we are committed to respecting your privacy and are committed to protecting your personal information. Our dental practice is bound by relevant Health Privacy Principles in state legislation and Commonwealth National Privacy Principles in the Privacy Act (1988).", "We are also bound by other applicable codes of conduct affecting your personal information, such as the Health Records Act 2001 (VIC) and the Health Records and Information Privacy Act 2002 (NSW).", "Our staff members are trained on best practices in accordance with the set standards, procedures, and policies to respect your privacy. We also review our privacy policies on a regular basis to keep up with policy changes."],
    list: null
}, 
{
    id: "privacy-policy2",
    title: [{id: "privacy-policy2.head1", varaint: "h4", text: "About Our Privacy Policy"}],
...
{
    id:"privacy-policy3",
    title: [{id: "privacy-policy3.head1", varaint: "h4", text: "Collecting Your Personal Information"}],
...
{
    id:"privacy-policy4",
    title: [{id: "privacy-policy4.head1", varaint: "h4", text: "Using and disclosing your personal information"}],
...
{
    id: "privacy-policy6",
    title: [{id: "privacy-policy6.head1", varaint: "h4", text: "Protecting your personal information"}],
    ...
    list: [{ id: "privacy-policy6-list1", text: "Confidential agreements for all of our employees"},
    { id: "privacy-policy6-list2", text: "Security policies for all document storage"},
    { id: "privacy-policy6-list3", text: "System access security measures"},
    { id: "privacy-policy6-list4", text: "Providing a discrete environment for all confidential discussions within the dental clinic"},
    { id: "privacy-policy6-list5", text: "Personal information transfers are only allowed when the initial seeking access provides written consent."},
    { id: "privacy-policy6-list6", text: "Controlled access to all of our buildings"},
    { id: "privacy-policy6-list7", text: "Electronic records systems for records backups on cloud storage providers located outside Australia"}], 
}, 
// single heading
{
    id: "privacy-policy7",
    title: [{id: "privacy-policy7.head1", varaint: "h4", text: "Your privacy on the internet"}],
    para: null,
    list: null
},
...
{
    id:"privacy-policy8",
    title: [{id: "privacy-policy8.head1", varaint: "h4", text: "Our Websites"}],
    para: ["No intentional personal information collection is undertaken by secret means on our website."],
    list: null
},
{
    id:"privacy-policy9",
    title: [{id: "privacy-policy9.head1", varaint: "h4", text: "Links to other sites"}],
...
{
    id: "privacy-policy10",
    title: [{id: "privacy-policy10.head1", varient: "h4", text: "Gaining access to your personal information"}],
...
{
    id: "privacy-policy11",
    title: [{id: "privacy-policy11.head1", varient: "h4", text: "Using Government Identifiers"}],
...
{
    id: "privacy-policy12",
    title: [{id: "privacy-policy12.head1", varient: "h4", text: "Dealing with us with a pseudonym or anonymously"}],
...
{
    id: "privacy-policy13",
    title: [{id: "privacy-policy13.head1", varient: "h4", text: "Resolving Your Privacy Issues"}],
    para: ["Our dental clinic provides various ways to resolve any issues you may have with our privacy policy. These include:"],
    list: [{ id: "privacy-policy13-list1", text: "You are always welcome to communicate directly with any member of our staff, and they will help you to the best of their abilities."},
    { id: "privacy-policy13-list2", text: "You can talk to your treating dental practitioner to resolve your issue."},
    { id: "privacy-policy13-list3", text: "You can contact the dental practice principal owner via the contact details provided on the website."},
    { id: "privacy-policy13-list4", text: "If the issue is not resolved to your satisfaction via any of our communication channels, you can always let us know, and we will investigate the specific case and keep you advised of progress. If such channels still don’t bear any progress, the issue will be escalated to the appropriate channels to facilitate resolution."}]
},
{
    id: "privacy-policy14",
    title: [{id: "privacy-policy14.head1", varient: "h4", text: "Contacting Us"}],
...
{
    id: "privacy-policy15",
    title: [{id: "privacy-policy15.head1", varient: "h4", text: "Website Privacy and Copyright"}],
...
{
    id: "privacy-policy16",
    title: [{id: "privacy-policy16.head1", varient: "h4", text: "Collecting your information"}],
    para: ["We do not collect personal information through this website as a standard practice. If for any reason, we end up collecting personal information on this website, we will expressly provide a purpose of use on the website.",
            "Our dental clinic may offer the services of collecting address information changes and collecting personal information and medical history of any new patients. These services may or may not be provided on this site, and you are encouraged to contact us at the address provided on this page. If offered, the service is only intended for patients who have already booked an appointment with our dentists and have been advised of the availability of this service.",
            "This website will generally communicate the information via standard encryption emails unless stated otherwise. We cannot guarantee that all data transmission over the internet will be 100% secure.",
...
{
    id: "privacy-policy17",
    title: [{id: "privacy-policy17.head1", varient: "h4", text: "Statistics"}],
    para: ["Our web hosting company will automatically record information regarding your visit for statistical purposes. The information includes your server’s address, your domain name, date and time of your visit, the pages you accessed and specific documents you downloaded, previous web visits you may have visited, and the type of browser used to access the site. This information is used to assess the visitors’ traffic and discover what information is most relevant and how to improve other parts of the site to make them helpful to visitors.",
"Our website will not attempt to identify users and their browsing activities in the unlikely event of an investigation where law enforcement agencies can exercise a warrant to inspect the web hosting logs that may contain such information.",
"This website contains external links that we are not responsible for the privacy practices and content published on them. We encourage you to examine each website’s privacy policy and make your personal decision on the correctness of the information found and its reliability."],
    list: null
},
{
    id: "privacy-policy18",
    title: [{id: "privacy-policy18.head1", varient: "h4", text: "Security"}],
    para: ["The internet is not always a secure environment, and if you send us any information via your email address, it is at your own risk. All patient information forms and address changes are emailed directly to the clinic’s email address on standard protocols. The information is not permanently stirred on the web hosting company’s or developer’s database.",
"Any information collected by the dental practice is changeable and viewable at the dental practice. In case you are worried about the security or sensitivity of the information, kindly contact us directly via phone or pay us a visit.",
"We will not disclose or use personal information for other purposes without your express consent unless required to disclose by the law. If you believe that we have failed to adhere to the principles in this [privacy statement or you have any comments on the privacy policy, please get in touch with us @ carrumdowsndental@gmail.com"],
    list: null
},
{
    id: "privacy-policy19",
    title: [{id: "privacy-policy19.head1", varient: "h4", text: "Use of cookies"}],
    ...
    "Most browsers are set up to auto-accept cookies. If you wish to stop receiving cookies, you can set your browser to reject all cookies or notify you each time a request to use cookies is made.",
    "Please note that some browsers can allow cookie access from other servers besides the origin server. Feel free to contact us with any queries regarding how we handle your personal information and our privacy issues"],
    list: null
},
{
    id: "privacy-policy20",
    title: [{id: "privacy-policy20.head1", varient: "h4", text: "Copyright"}],
    para: ["The information on this website is subject to Australian copyright laws."],
    list: null
},
{
    id: "privacy-policy21",
    title: [{id: "privacy-policy21.head1", varient: "h4", text: "Liability"}],
    para: ["We are not responsible to you or another party for losses suffered in connection with the use of any of this website and any of its contents. This includes but is not limited to any transmissions that might contain computer viruses.",
    "The clinic makes no representations or warranties about this website or any of the content published on it. To the maximum extent permitted by law, we exclude any liability which may arise from the use of this website, its information, or the content on it. Where the liability cannot be excluded, any liability by us in relation to the usage of this website or its content is limited under the Trade Practices Act 1974 (S68A). The clinic will never be held liable for any indirect, special, incidental, or consequential loss that arises from the use of this website, including but not limited to loss of business profits and medical and health consequences."
],
    list: null
},
{
    id: "privacy-policy22",
    title: [{id: "privacy-policy22.head1", varient: "h4", text: "Our Intellectual Property"}],
    para: ["Some of the content published on this website may be owned by someone else’s copyright and is included under a license or agreement. You may only use the content for non-commercial use or access it for personal use unless you have written approval from us. Any content on this website can be printed for your personal use.",
    "All other uses that may include copying and reproduction of this website or any parts of its content are prohibited to the extent permitted by law. None of the content published on this website may be reproduced on another website. If you seek to use the content in any other way, it’s your responsibility to obtain prior approval where necessary.",
   ],
    list: null
},{
    id: "privacy-policy23",
    title: [{id: "privacy-policy23.head1", varient: "h4", text: "Links from this website"}],
    para: ["Our web pages contain external links to other websites that we have no control ove3r. We make no representations of the accuracy of any information found on these websites. We are not liable for any content on these websites.",
    "If you have any questions or comments on our privacy policy, feel free to get in touch with us on the “contact us” page, and we will get back to you promptly.",
    ],
    list: null
},
]
